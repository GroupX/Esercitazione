		...
		do
		{
			...
			switch (scelta)
			{
				...
				case SCELTA_BISCOTTI:
					...
					// Controlla che non vengano dati biscotti in numero
					// negativo
			...
			// IOLib.printLine("Affetto: " + tama.getAffetto() + "   Sazietà: "
			// + tama.getSazieta());
			// IOLib.printLine ("Effetto carezza: " + tama.getEffettoCarezza ()
			// + "   Effetto biscotto: " + tama.getEffettoBiscotto ());
