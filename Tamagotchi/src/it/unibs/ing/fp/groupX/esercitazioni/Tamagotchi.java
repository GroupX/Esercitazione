...
public class Tamagotchi
{
	...
	private static final double DIMINUZIONE_EFFETTO = 0.0001, AUMENTO_EFFETTO = 0.10, MINIMO_EFFETTO = 0.01;
	 ...
	 *            Nome del Tamagotchi
	 * @param sazieta
	 *            valore d'inizializzazione per il grado di sazietà
	 * @param affetto
	 *            valore d'inizializzazione per il grado d'affetto
	 */
	...
	public void daiCarezza (int numCarezze)
	{
		...
		{
			/*
			 * EVOLUZIONE: l'effetto delle carezze diminuisce con l'aumentare di carezze date, ma aumenta l'effetto dei biscotti. Se l'effetto delle carezze è al minimo, l'effetto dei biscotti è al massimo.
			 */
	...
	public void daiBiscotto (int numBiscotti)
	{
		...
		{
			/*
			 * EVOLUZIONE: l'effetto dei biscotti diminuisce con l'aumentare di biscotti dati, ma aumenta l'effetto delle carezze. Se l'effetto dei biscotti è al minimo, l'effetto delle carezze è al massimo.
			 */
