...
public class Tamagotchi {
	...
	public Tamagotchi (String nome, int gradoAffettivo, int gradoSazietà, String nomeTipo)
	{
		this.nome=nome;
	...
	public String toString()
	{
		...
		result.append(String.format(DESCRIZIONE, nome, nomeTipo, gradoSazietà, gradoAffettivo));
		if (sonoMorto())
